...
from environment import simple_env  # Import the custom environment
...
total_timesteps = 3000000  # Total timesteps for training
checkpoint_timesteps = [1000000, 2000000, 3000000]  # Define checkpoints
